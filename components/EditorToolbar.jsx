		...
		<div className='w-full flex gap-4 justify-between'>
			...
			<span>
				...
				<div className='flex items-center space-x-2'>
					...
					<button
						...
						className={`w-12 h-6 flex items-center rounded-full p-1 transition-colors ${drawMode === 'rect' ? 'bg-blue-600 justify-end' : 'bg-green-600 justify-start'}`}>
			...
			{mode === 'create' ? (
				<div className='flex gap-2 items-center'>
					<Button onClick={saveGame} aria-label='Save level' variant='primary' disabled={!modified}>
						Save level
					</Button>
				</div>
			) : (
