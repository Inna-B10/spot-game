	...
	return (
		<AlertDialogPortal>
			...
			<AlertDialogPrimitive.Content
				...
				className={cn(
					'bg-white data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 fixed top-[30%] left-[50%] z-50 grid w-full max-w-[calc(100%-2rem)] translate-x-[-50%] translate-y-[-70%] gap-x-4 gap-y-6 rounded-lg border-gray-300 px-6 py-8 shadow-lg duration-200 sm:max-w-lg',
					className
				)}
				{...props}
			/>
...
function AlertDialogFooter({ className, ...props }) {
	return <div data-slot='alert-dialog-footer' className={cn('flex flex-col-reverse gap-2 sm:flex-row sm:justify-center', className)} {...props} />
}
